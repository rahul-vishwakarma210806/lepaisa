...
// Output: public/plinko-outcomes.json
// ═══════════════════════════════════════════════════════════════
...
function main() {
    ...
    const outPath = path.resolve(__dirname, '..', 'public', 'plinko-outcomes.json');
    fs.writeFileSync(outPath, JSON.stringify(allOutcomes), 'utf-8');
