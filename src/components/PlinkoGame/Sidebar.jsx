...
function Sidebar({
    ...
    return (
        <div className="sidebar">
            {/* Wallet Balance */}
            <div className="game-wallet-balance" aria-label="Wallet balance">
                <span className="game-wallet-balance-label">Wallet Balance</span>
                <strong>₹{Number(balance || 0).toLocaleString('en-IN', {
